...
export default function HakkimdaRedirectPage() {
  ...
  useEffect(() => {
    ...
    router.replace("/giris?uyari=Bu%20sayfaya%20eri%C5%9Fmek%20i%C3%A7in%20giri%C5%9F%20yapmal%C4%B1s%C4%B1n%C4%B1z.&from=/profil/hakkimda");
