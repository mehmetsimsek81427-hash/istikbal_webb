          ...
          <div className="w-full md:w-[45%] lg:w-[40%] p-8 md:p-10 lg:p-12 flex flex-col justify-center relative z-20">
            ...
            <div className="mt-8 flex flex-col gap-3">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <a href="mailto:demkamobiyaistikbal@gmail.com" className="flex items-center text-white/90 text-xs bg-white/5 px-4 py-2.5 rounded-lg border border-white/10 hover:bg-white/12 hover:border-white/20 transition-all duration-300 ease-out cursor-pointer">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 mr-2 text-[#F2A900]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
